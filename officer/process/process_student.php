            ...
            if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                try {
                    ...
                    if ($result) {
                        ...
                        // สร้างบัญชีผู้ใช้สำหรับนักศึกษาใหม่ (ถ้าต้องการ)
                        $controller->createLoginForStudent($student_id);
                    } else {
        ...
        case 'edit':
            ...
            if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                try {
                    ...
                    $curriculum_id = isset($_POST['edit_curriculum_id']) ? trim($_POST['edit_curriculum_id']) : '';
