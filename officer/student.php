                        ...
                        <table id="table1" class="table table-bordered table-striped">
                            <thead>
                                <tr class="bg-light">
                                    ...
                                    <th width="17%">ชื่อ</th>
                                    <th width="17%">นามสกุล</th>
                                    <th width="18%">สาขาวิชา</th>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="plan_id">หลักสูตร <span class="text-danger">*</span></label>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="edit_plan_id">หลักสูตร <span class="text-danger">*</span></label>
...
$(document).ready(function() {
    ...
    // ฟังก์ชันใหม่สำหรับจัดการแสดง/ซ่อนช่องกรอกศาสนาอื่นๆ
    function handleReligionOther() {
        console.log("Handling religion dropdowns");

        // สำหรับฟอร์มเพิ่มนักศึกษา
        if ($("#religion").length) {
            console.log("Add form - Religion value:", $("#religion").val());
            if ($("#religion").val() === "อื่นๆ") {
                $("#other_religion_div").show();
                console.log("Should show other religion input in add form");
            } else {
                $("#other_religion_div").hide();
            }
        }

        // สำหรับฟอร์มแก้ไขนักศึกษา
        if ($("#edit_religion").length) {
            console.log("Edit form - Religion value:", $("#edit_religion").val());
            if ($("#edit_religion").val() === "อื่นๆ") {
                $("#edit_other_religion_div").show();
                console.log("Should show other religion input in edit form");
            } else {
                $("#edit_other_religion_div").hide();
            }
        }
    }

    // เรียกฟังก์ชันตอนเริ่มต้น
    handleReligionOther();

    // ผูกฟังก์ชันกับเหตุการณ์เปลี่ยนแปลงค่า
    $("#religion").on("change", function() {
        console.log("Religion changed to:", $(this).val());
        handleReligionOther();
    });

    $("#edit_religion").on("change", function() {
        console.log("Edit religion changed to:", $(this).val());
        handleReligionOther();
    });
});
