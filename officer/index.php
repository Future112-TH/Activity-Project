...
<body>
    <div class="wrapper">
        ...
        switch($menu){
            ...
            case 8: require_once 'activity_type.php'; break;

            case 9: require_once 'activity.php'; break;
            case 10: require_once 'comparision.php'; break;

            case 11: require_once 'result.php'; break;
            case 12: require_once 'transcript.php'; break;
