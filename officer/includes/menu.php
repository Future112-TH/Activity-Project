        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
               ...
               with font-awesome or any other icon font library -->
                ...
                <li
                    class="nav-item <?php if($menu==4 || $menu==5 || $menu==6 || $menu==7 || $menu==8){echo 'menu-open';} ?>">
                    <a href="#"
                        class="nav-link <?php if($menu==4 || $menu==5 || $menu==6 || $menu==7 || $menu==8){echo 'active';} ?>">
                ...
                <li class="nav-item <?php if($menu==11 || $menu==12){echo 'menu-open';} ?>">
                    <a href="#" class="nav-link <?php if($menu==11 || $menu==12){echo 'active';} ?>">
